...
class Ejercicio5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(+a + "%" + b + "=" + modulo(a, b)); // Muestra el residuo de la division utilizando los
                                                               // valores ingresados :)

    }

    public static double modulo(double a, double b) { // Método estático que recibe dos números :)

        return a % b; // Devuelve el residuo de dividir los numeros :)
